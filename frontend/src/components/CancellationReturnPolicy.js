...
function CancellationReturnPolicy() {
  ...
  return (
    <Box sx={{ bgcolor: '#fff' }}>
      ...
      {/* Cancellation & Return Policy Content with Full Background */}
      <Box 
        sx={{ 
          position: 'relative',
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, py: { xs: 4, md: 6 } }}>
          <Box sx={{ 
            ...
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 3 }}>
              When you are not satisfied with our product, Sagar Jewellers allows you to cancel your order online before the product has been shipped. Your entire order amount will be refunded.
            </Typography>
            
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 3 }}>
              You can send the reason for the cancellation and Sagar Jewellers has to approve your request to process your cancellation. Approval will be based on valid reasons.
            </Typography>
            ...
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 2 }}>
              If for some reason you are not entirely satisfied with your product, Sagar Jewellers is glad to sort out the problem or exchange the product.
            </Typography>
            
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 2 }}>
              Please see below for the terms and conditions of our exchange policies:
            </Typography>
            
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 2 }}>
              <strong>30-Day Exchange and Money Back Policy:</strong> If you are not satisfied with your product, you may return it within 30 days of receipt for a refund or exchange on the full invoice value. You can return any of our products except for products that have been customized for you.
            </Typography>
            ...
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.8, mb: 2 }}>
              If you have any questions about our Cancellation & Return Policy, please feel free to contact us through our website or write to us at Sales@sagarjewels.in
            </Typography>
          </Box>
        </Container>
      </Box>
